...
Return the full HTML document only.`;
  ...
  try {
    const maxTokens = aiResult.config.provider === "anthropic" ? 24000 : 16000;
    const t0 = Date.now();
